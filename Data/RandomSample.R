...
# samples randomly selected on 12/7/2016 for first proteomic analysis
Dec7.analysis <- c("G10", "G18", "G48", "G58", "G68", "G77", "G92", "G97", "G119", "G131")
as.character(Dec7.analysis)
GeoduckOA[c(GeoduckOA$PRVial=="G68"),]
